...
class Ventana_inicial:
    ...
    def __init__(self,ventana0,diccionario_cinema) -> None:
    ...
    def ir_ventana_1(self,id_local):
        
        self.informacion_local=id_local
...
class Pantalla_principal:
    ...
    def creacion_botones(self, lista_id_imagenes):
        ...
        for n in range(1,7):
            ...
            url_info_pelis_botones_ver = "http://vps-3701198-x.dattaweb.com:4000/movies/" + f"{lista_id_imagenes[n]}"
...
class Ventana2:
    ...
    def __init__(self, ventana,dict_info_peliculas,ventana1,informacion_local) -> None:
    ...
    def crear_frames(self,ventana1):
    ...
    def crear_imagen(self) -> any:
        ...
        self.url_api = 'http://vps-3701198-x.dattaweb.com:4000/posters/'+self.id
        self.token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.DGI_v9bwNm_kSrC-CQSb3dBFzxOlrtBDHcEGXvCFqgU'
        self.headers = {'Authorization': f'Bearer {self.token}'}
        self.response = requests.get(self.url_api, headers=self.headers)
    ...
    def crear_etiquetas(self,ventana1):
        
        #ESTO ES LO DE LA IMAGEN EN LA VENTANA 2 PERO ESTA ROTO :/
        #self.etiqueta_imagen = tk.Label(self.pantalla_ventana_2_num1, image= self.crear_imagen())
        #DESPUES AGREGAR ESTA IMAGEN O NO; VEMOS DESPUES QUE TAN COMPLICADO ES XDDD
    ...
    def ir_ventana3(self):
        ...
        pantalla_reserva=Ventana_3(ventana3,get_url,self.informacion,self.informacion_local)
        
        pantalla_reserva.ventana3.mainloop()
        
    
    def volver_ventana1(self,ventana1):
        self.ventana_2.withdraw() 
        ventana1.deiconify()
    
    
    def crear_botones(self,ventana1):
...
#====================================================================================================================       
class Ventana_3:
    def __init__(self,ventana3, get_url,informacion,informacion_local) -> None:
...
class Qr_ventana():
    ...
    def agregar_qr(self):
        ...
        for i in self.info_qr:
            ...
            if i!="Monto" and i!="Snacks":
                data.append(f"\n{i}: {self.info_qr[i]}")
            
        
        fecha_compra = datetime.now().strftime("Hoy: %d/%m\nhora:%Hhs:%Mmin") #%Y-%m-%d-%H-%M"
...
def main():
    ...
    lista_tu_vieja=response.json()

    diccionario_cinema={}

        
    for i in range(len(lista_tu_vieja)):
        
        diccionario_cinema[lista_tu_vieja[i]["cinema_id"]]=lista_tu_vieja[i]
